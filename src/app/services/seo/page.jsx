          ...
          <div className="flex px-[5em] max-lg:px-[3em] max-md:px-[2em] max-sm:pt-[40%] max-sm:pb-[10%] max-lg:pt-[30%] lg:pt-[22%] lg:pb-[16%] 1920:py-[18%]">
            <div className="relative z-10">
              <div className="mb-8 md:mb-16 flex items-center gap-3 text-sm 1366:text-base 1440:text-lg 1600:text-xl">
                ...
                <p className="font-poppins font-medium">SEO</p>
              </div>

              <h1 className="text-3xl sm:text-4xl md:text-[clamp(50px,4vw,74px)] lg:text-[clamp(40px,4vw,74px)] font-normal font-sora uppercase mb-4 tracking-tight leading-8 md:leading-15 lg:leading-12 1280:leading-15 1600:leading-18 1920:leading-20.25">
              ...
              <p className="font-sora font-normal text-white/70 text-[clamp(12px,1.5vw,20px)] md:text-[clamp(13px,1.08vw,20px)] lg:text-[clamp(11px,1.1vw,20px)]">
        ...
        <div className="relative">
          ...
          <section className="relative z-10 py-16 md:py-24 1440:py-40 px-8 sm:px-10 md:px-16 lg:px-24 xl:px-36">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              {/* Image column */}
              <div className="max-sm:mt-10 1280:-mt-24 max-xl:mt-0 relative z-10 col-span-1 flex items-center justify-center">
                <img
          ...
          <img
            ...
            className="relative z-10 h-full md:h-[125vh] w-full object-cover"
          />
        </div>
